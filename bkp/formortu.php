...
$qortu=mysqli_query($sqlconn,"SELECT*FROM tb_ortu WHERE nopend='$_SESSION[s_user]'");
...
<div class="alert alert-warning">
	<p><strong>Petunjuk</strong><br/>Silahkan lengkapi data orang tua anda, isilah sesuai dengan keadaan sebenarnya<p>
</div>
	...
	<div class="card-footer">
		<div class="row" align="center">
			<div class="col-sm-4 col-md-4 col-lg-4" style="padding-bottom:5px">
				<a href="?p=isiform" class="btn btn-lg btn-default btn-flat btn-block col-8">
			...
			<div class="col-sm-4 col-md-4 col-lg-4" style="padding-bottom:5px">
				<a href="?p=datanilai" class="btn btn-lg btn-success btn-flat btn-block col-8">
			...
			$("#simpan").click(function(){
				...
				if(nama=="" || nama==null){
					...
					$.ajax({
						type:"POST",
						url:"simpansiswa.php",
						data: "aksi=ortu&nama="+nama+"&nik="+nik+"&tmplahir="+tmplahir+"&tgllahir="+tgllahir + "&agama="+agama + "&pendidikan="+pendidikan+"&kerja="+kerja+"&kerja="+kerja+"&hasil="+hasil+"&hubkel="+hubkel+"&almt="+almt+"&desa="+desa + "&kec="+kec +"&kab="+kab + "&prov=" + prov +"&kdpos="+kdpos + "&nohp="+nohp,
