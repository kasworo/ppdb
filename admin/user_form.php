...
if($_REQUEST['m']=='1'){
    ...
    $qpg=mysqli_query($sqlconn,"SELECT*FROM tb_user WHERE username='$id'");
    $pg=mysqli_fetch_array($qpg);
    $kode=$pg['username'];
    $nama=$pg['nama'];
    $nip=$pg['nip'];
    $tmpl=$pg['tmplahir'];
    ...
    $qpg=mysqli_query($sqlconn,"SELECT*FROM tb_user WHERE username='$_COOKIE[c_user]'");
    $pg=mysqli_fetch_array($qpg);
    $kode=$pg['username'];
    $nama=$pg['nama'];
    $nip=$pg['nip'];
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="row" style="padding-bottom:5px">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control form-control-sm" name="nip" id="nip" value="<?php echo $nip;?>" onkeyup="validAngka(this)"> 
                        </div>
                    </div>
                    <div class="row" style="padding-bottom:5px">
                    ...
                    <div class="row" style="padding-bottom:5px">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control form-control-sm" name="jbtp" id="jbtp">
                                <?php
                                switch($jbtp){
                ...
                <div class="col-sm-6">
                    <div class="row" style="padding-bottom:5px">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control form-control-sm" name="imel" id="imel" value="<?php echo $imel;?>">
                        </div>
                    </div>
                    <div class="row" style="padding-bottom:5px">
                    ...
                    <div class="row" style="padding-bottom:5px">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control form-control-sm" name="kdpos" id="kdpos" value="<?php echo $kpos;?>">
                        </div>
                    </div>
                    <div class="row" style="padding-bottom:5px">
